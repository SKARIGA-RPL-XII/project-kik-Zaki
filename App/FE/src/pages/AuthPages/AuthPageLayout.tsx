  ...
  return (
    <div className="relative p-6 bg-white z-1 dark:bg-neutral-900 sm:p-0">
      <div className="relative flex flex-col justify-center w-full h-screen lg:flex-row dark:bg-neutral-900 sm:p-0">
        {children}
        <div className="items-center hidden w-full h-full lg:w-1/2 bg-indigo-950 dark:bg-white/5 lg:grid">
            ...
            <div className="flex flex-col items-center max-w-xs">
              <Link to="/" className="block mb-4">
                <img
                  width={150}
                  height={48}
                  src="/GAGALLAPAR-Logo-1.png"
                  alt="Logo"
                />
              </Link>
              <p className="text-center text-neutral-400 dark:text-white/60 font-light">
