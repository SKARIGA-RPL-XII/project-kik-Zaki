        ...
        >
          ...
          <div className="dz-message flex flex-col items-center m-0!">
            ...
            <div className="mb-[22px] flex justify-center">
              <div className="flex h-[68px] w-[68px]  items-center justify-center rounded-full bg-neutral-200 text-neutral-700 dark:bg-neutral-800 dark:text-neutral-400">
                <svg
            ...
            {/* Text Content */}
            <h4 className="mb-3 font-semibold text-neutral-800 text-theme-xl dark:text-white/90">
              {isDragActive ? "Drop Files Here" : "Drag & Drop Files Here"}
            </h4>

            <span className=" text-center mb-5 block w-full max-w-[290px] text-sm text-neutral-700 dark:text-neutral-400">
