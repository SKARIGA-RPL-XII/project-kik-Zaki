        ...
        <div>
          ...
          <div className="relative">
            <Input
              ...
              className="pl-[62px]"
            />
            <span className="absolute left-0 top-1/2 flex h-11 w-[46px] -translate-y-1/2 items-center justify-center border-r border-neutral-200 dark:border-neutral-800">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
