  ...
  return (
    <header className="sticky top-0 flex w-full bg-white border-neutral-200 z-999 dark:border-neutral-800 dark:bg-neutral-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-neutral-200 dark:border-neutral-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          <button
            className="block w-10 h-10 text-neutral-500 lg:hidden dark:text-neutral-400"
            onClick={onToggle}
          >
            {/* Hamburger Icon */}
            <svg
          ...
          <button
            onClick={onClick}
            className="items-center justify-center hidden w-10 h-10 text-neutral-500 border-neutral-200 rounded-lg z-99999 dark:border-neutral-800 lg:flex dark:text-neutral-400 lg:h-11 lg:w-11 lg:border"
          >
            <svg
            ...
            <form action="https://formbold.com/s/unique_form_id" method="POST">
              <div className="relative">
                ...
                <input
                  ...
                  className="dark:bg-dark-900 h-11 w-full rounded-lg border border-neutral-200 bg-transparent py-2.5 pl-12 pr-14 text-sm text-neutral-800 shadow-theme-xs placeholder:text-neutral-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-neutral-800 dark:bg-neutral-900 dark:bg-white/[0.03] dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800 xl:w-[430px]"
                />
