  ...
  return (
    <div className="rounded-2xl border border-neutral-200 bg-neutral-100 dark:border-neutral-800 dark:bg-white/[0.03]">
      ...
      <div className="flex items-center justify-center gap-5 px-6 py-3.5 sm:gap-8 sm:py-5">
        <div>
          <p className="mb-1 text-center text-neutral-500 text-theme-xs dark:text-neutral-400 sm:text-sm">
            Target
          </p>
          <p className="flex items-center justify-center gap-1 text-base font-semibold text-neutral-800 dark:text-white/90 sm:text-lg">
            $20K
            <svg
              width="16"
              height="16"
